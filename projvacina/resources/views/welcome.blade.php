...
<body id="top">
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <ul class="header-nav__list">
                    ...
                    <li class="current"><a href="{{ route('login') }}" title="Login/Cadastro">Login/Cadastro</a></li>
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/inicial.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1>
                    ...
                    visualização de vacinas <br>
                    on-line. 
                </h1>

                <div class="home-content__buttons">
                    <a href="/login" class="btn btn--stroke">
                        Login
                    </a>
                    <a href="/login#openRegModal" class="btn btn--stroke">
                        Cadastro
                    </a>
                </div>
    ...
    <footer>
        ...
        <div class="row footer-bottom">
            ...
            <div class="col-twelve">
                <div class="copyright">
                    <span>© Copyright ProjetoVacina 2018</span> 
